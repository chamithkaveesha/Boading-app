...
function RePayment() {
    ...
    }, [loading, payer, payee, totalValue, description, room]);
            ...
            <div className="w-full max-w-4xl">
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-black to-green-700 px-4 sm:px-8 py-4 sm:py-6">
                        <h2 className="text-xl sm:text-3xl font-bold text-white text-center">Create Re-Payment</h2>
                    ...
                    <div className="p-4 sm:p-8 space-y-4 sm:space-y-8">
                        ...
                        <section className="space-y-2 sm:space-y-4">
                            <div className="flex items-center space-x-2">
                                <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Select Payee</h3>
                                <span className="text-red-500">*</span>
                            </div>
                            ...
                            {validationErrors.payee && (
                                <p className="text-red-500 text-xs sm:text-sm">{validationErrors.payee}</p>
                            )}
                        </section>
