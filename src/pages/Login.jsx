...
function Login() {
    ...
    return (
        <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-green-50 p-3 sm:p-4">
            <div className="w-full max-w-sm sm:max-w-md">
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-black to-green-700 px-4 sm:px-8 py-4 sm:py-6">
                        ...
                        <p className="text-green-100 text-center mt-2 text-xs sm:text-sm">Sign in to your account</p>
                    </div>
                    
                    {/* Form Section */}
                    <form onSubmit={handleSubmit(onSubmit)} className="px-4 sm:px-8 py-6 sm:py-8">
                        {error && (
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div>
                                ...
                                <input 
                                    {...register("email")} 
                                    type="email" 
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 outline-none text-sm sm:text-base" 
