...
function Payment() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 py-2 px-3 overflow-y-auto">
            {/* Success Popup */}
            {showSuccessPopup && (
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md mx-4 transform animate-pulse">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 text-sm">Your payment has been created successfully.</p>
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className="w-full max-w-3xl mx-auto mb-4">
                <div className="bg-white rounded-xl shadow-xl overflow-hidden">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-black to-green-700 px-6 py-4">
                        <h2 className="text-2xl font-bold text-white text-center">Create Payment</h2>
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <section className="space-y-3">
                            ...
                            <textarea
                                ...
                                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 outline-none resize-none ${
                        ...
                        <section className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="number"
                                    placeholder="0.00"
                                    className={`w-full pl-12 pr-3 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 outline-none font-medium ${
                        ...
                        <div className="pt-2">
                            <button
                                type="button"
                                className="w-full bg-gradient-to-r from-black to-green-700 text-white py-3 rounded-lg font-semibold hover:from-gray-800 hover:to-green-800 transform hover:scale-[1.02] transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg"
